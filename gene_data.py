...
if __name__ == '__main__':
    ...
    # print the percentage between text region and non-text region
    # the percentage is wrong, should rewrite the code
    print 'text divide non-text region is:'
    print num_text_pixel / num_not_text_pixel
    # wirte data
    file_write = h5py.File('train_dataset-5000.h5', 'w')
